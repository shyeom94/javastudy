...
public class BankAccount {
  ...
  // 입금
  public void deposit(long money) throws RuntimeException {  // throws RuntimeException 으로 예외처리 
    
    if(money <= 0) {
      throw new RuntimeException(money + "원 입금 불가"); // 예외 처리 메시지, throw 는 메소드를 호출한 곳(MainClass)으로 던졌다.
    }
    balance += money;
  }
  ...
  // 이체 (송금)
  public void transfer(BankAccount account, long money) throws RuntimeException { // 예외 처리 throws RuntimeException 필요하다.
